    ...
    public class DataManage
    {
        ...
        public static async Task SeedOrderStatusAsync(ApplicationDbContext _context)
        {
            if (_context.OrderStatuses.ToList().Count == 0)
            {
                ...
                {
                    Name = "Received",
                    Description = "Esam saņēmuši jūsu pasūtījumu"
                };
                ...
                {
                    Name = "Working",
                    Description = "Strādājam pie jūsu pasūtījuma"
                };
                ...
                {
                    Name = "Shipped",
                    Description = "Esam izsūtījuši jūsu pasūtījumu"
                };
                ...
                {
                    Name = "IsShipping",
                    Description = "Jūsu pasūtījums atrodas jau ceļā"
                };
                ...
                {
                    Name = "Finish",
                    Description = "Pasūtījums veiksmīgi piegādāts"
                };
                ...
                {
                    Name = "Sorry",
                    Description = "Atvainojiet, kaut kas nogāja greizi, bet mēs turpinam strādāt pie jūsu pasūtījuma"
                };
        ...
        public static async Task SeedCategoryAsync(ApplicationDbContext _context, ISlugService _slugService)
        {
            ...
            {
                Category Portatīvās_Radiostacijas = new Category
                {
                    Name = "Portatīvās Radiostacijas",
                    Description = "Portatīvās Radiostacijas Portatīvās Radiostacijas Portatīvās Radiostacijas Portatīvās Radiostacijas Portatīvās Radiostacijas Portatīvās Radiostacijas",
                    Slug = _slugService.URLFriendly("Portatīvās Radiostacijas")

                };
                await _context.AddAsync(Portatīvās_Radiostacijas);
                await _context.SaveChangesAsync();

                Category Mobīlās_Radiostacijas = new Category
                {
                    Name = "Mobīlās Radiostacijas",
                    Description = "Mobīlās Radiostacijas Mobīlās Radiostacijas Mobīlās Radiostacijas Mobīlās Radiostacijas Mobīlās Radiostacijas Mobīlās Radiostacijas Mobīlās Radiostacijas Mobīlās Radiostacijas",
                    Slug = _slugService.URLFriendly("Mobīlās Radiostacijas")
                };
                await _context.AddAsync(Mobīlās_Radiostacijas);
                await _context.SaveChangesAsync();

                Category Aksesuāri = new Category
                {
                    Name = "Aksesuāri",
                    Description = "Aksesuāri Aksesuāri Aksesuāri Aksesuāri Aksesuāri Aksesuāri Aksesuāri",
                    Slug = _slugService.URLFriendly("Aksesuāri")
                };
                await _context.AddAsync(Aksesuāri);
                await _context.SaveChangesAsync();
            }
        }
        ...
        public static async Task SeedItemAsync(ApplicationDbContext _context, ISlugService _slugService)
        {
            if (_context.Item.ToList().Count == 0)
            {
                ...
                var Portatīvās_RadiostacijasCategoryId = (await _context.Category.FirstOrDefaultAsync(i => i.Name == "Portatīvās Radiostacijas")).Id;
                var Mobīlās_RadiostacijasCategoryId = (await _context.Category.FirstOrDefaultAsync(i => i.Name == "Mobīlās Radiostacijas")).Id;
                var AksesuāriCategoryId = (await _context.Category.FirstOrDefaultAsync(i => i.Name == "Aksesuāri")).Id;
                var RateId = (await _context.Rate.FirstOrDefaultAsync(i => i.Name == "Excellent")).Id;
                Item item1 = new Item
                {
                    Name = "Portatīvās Radiostacijas one",
                    Description = "This portatīvās radiostacijas is a combination flavour of portatīvās radiostacijas one",
                    Price = "1",
                    ImageData = null,
                    ContentType = null,
                    ItemSaleOffId = NoSaleOffItemId,
                    ItemStatusId = normalItemId,
                    CategoryId = AksesuāriCategoryId,
                    Number_Of_Sold = 0,
                    ViewCount = 0,
                    IsProductReady = true,
                    Slug = _slugService.URLFriendly("Portatīvās Radiostacijas one"),
                    RateValue = 5
                ...
                Item item2 = new Item
                {
                    Name = "Portatīvās Radiostacijas two",
                    Description = "This portatīvās radiostacijas is a combination flavour of portatīvās radiostacijas two",
                    Price = "2",
                    ImageData = null,
                    ContentType = null,
                    ItemSaleOffId = NoSaleOffItemId,
                    ...
                    ViewCount = 0,
                    IsProductReady = true,
                    Slug = _slugService.URLFriendly("Portatīvās Radiostacijas two"),
                    RateValue = 5
                ...
                Item item3 = new Item
                {
                    Name = "Portatīvās Radiostacijas three",
                    Description = "This portatīvās radiostacijas is a combination flavour of portatīvās radiostacijas three",
                    Price = "1.5",
                    ImageData = null,
                    ContentType = null,
                    ItemSaleOffId = NoSaleOffItemId,
                    ...
                    ViewCount = 0,
                    IsProductReady = true,
                    Slug = _slugService.URLFriendly("Portatīvās Radiostacijas three"),
                    RateValue = 5
                ...
                Item item4 = new Item
                {
                    Name = "Mobīlās Radiostacijas One",
                    Description = "This mobīlās radiostacijas is a combination flavour of Mobīlās Radiostacijas One",
                    Price = "1.2",
                    ImageData = null,
                    ContentType = null,
                    ItemSaleOffId = NoSaleOffItemId,
                    ItemStatusId = normalItemId,
                    CategoryId = Mobīlās_RadiostacijasCategoryId,
                    Number_Of_Sold = 0,
                    ViewCount = 0,
                    IsProductReady = true,
                    Slug = _slugService.URLFriendly("Mobīlās Radiostacijas One"),
                    RateValue = 5
                ...
                Item item5 = new Item
                {
                    Name = "Mobīlās Radiostacijas Two",
                    Description = "This mobīlās radiostacijas is a combination flavour of Mobīlās Radiostacijas Two",
                    Price = "0.7",
                    ImageData = null,
                    ContentType = null,
                    ItemSaleOffId = NoSaleOffItemId,
                    ...
                    ViewCount = 0,
                    IsProductReady = true,
                    Slug = _slugService.URLFriendly("Mobīlās Radiostacijas Two"),
                    RateValue = 5
                ...
                Item item6 = new Item
                {
                    Name = "Mobīlās Radiostacijas Three",
                    Description = "This mobīlās radiostacijas is a combination flavour of Mobīlās Radiostacijas Three",
                    Price = "0.5",
                    ImageData = null,
                    ContentType = null,
                    ItemSaleOffId = NoSaleOffItemId,
                    ...
                    ViewCount = 0,
                    IsProductReady = true,
                    Slug = _slugService.URLFriendly("Mobīlās Radiostacijas Three"),
                    RateValue = 5
                ...
                Item item7 = new Item
                {
                    ...
                    ItemSaleOffId = NoSaleOffItemId,
                    ItemStatusId = normalItemId,
                    CategoryId = Portatīvās_RadiostacijasCategoryId,
                    Number_Of_Sold = 0,
                    ViewCount = 0,
                    IsProductReady = true,
                    Slug = _slugService.URLFriendly("Portatīvās Radiostacijas One"),
                ...
                {
                    Name = "Portatīvās Radiostacijas Four",
                    Description = "This Portatīvās Radiostacijas is a combination flavour of Portatīvās Radiostacijas Four",
                    Price = "1.30",
                    ImageData = null,
                    ContentType = null,
                    ItemSaleOffId = NoSaleOffItemId,
                    ...
                    ViewCount = 0,
                    IsProductReady = true,
                    Slug = _slugService.URLFriendly("Portatīvās Radiostacijas Four"),
                    RateValue = 5
        ...
        private static async Task SeedUserAsync(UserManager<CustomUser> userManagerSvc)
        {
            ...
            {
                Email = "ralfs.m.abols@gmail.com",
                UserName = "ralfs.m.abols@gmail.com",
                FirstName = "Ralfs Mārcis",
                LastName = "Ābols",
                PhoneNumber = "26640440",
                EmailConfirmed = true
            ...
            {
                Email = "raafuks@gmail.com",
                UserName = "raafuks@gmail.com",
                FirstName = "Ralfs",
                LastName = "Abols",
                PhoneNumber = "26640440",
                EmailConfirmed = true
        ...
        private static async Task AssignRoleAsync(UserManager<CustomUser> userManagerSvc)
        {
            ...
            var adminUser = await userManagerSvc.FindByEmailAsync("ralfs.m.abols@gmail.com");
            await userManagerSvc.AddToRoleAsync(adminUser, "Administrator");
            var modUser = await userManagerSvc.FindByEmailAsync("raafuks@gmail.com");
